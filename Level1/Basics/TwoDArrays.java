...
public class TwoDArrays {
    ...
    static void exitMatrix1(int[][] a){
        int i=0, j=0, m=a.length, n=a[0].length, dir=0;  // dir=0-e,1-s,2-w,3-n
    ...
    static void diagonalTraversal1(int[][] a){
